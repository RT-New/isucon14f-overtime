...
(
  ...
  PRIMARY KEY (id),
  INDEX idx_chairs_01(access_token)
)
  COMMENT = '椅子情報テーブル';
...
(
  ...
  created_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '登録日時',
  PRIMARY KEY (id),
  INDEX idx_chair_locations_01(chair_id, created_at desc)
)
...
(
  ...
  PRIMARY KEY (id),
  INDEX idx_rides_01(chair_id, updated_at desc),
  INDEX idx_rides_02(user_id, created_at desc)
)
  COMMENT = 'ライド情報テーブル';
...
(
  ...
  PRIMARY KEY (id),
  INDEX idx_ride_statuses_01(ride_id, created_at desc)
)
